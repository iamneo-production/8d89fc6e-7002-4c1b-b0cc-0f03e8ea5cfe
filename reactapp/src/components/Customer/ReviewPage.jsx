...
const ReviewPage = () => {
  ...
  const loadReviews = () => {
    axios
      .get('https://8080-bcdebecaeaabbdddabaaafdeafcffbbb.project.examly.io/user/getReview')
      .then((response) => {
  ...
  const addOrUpdateReview = () => {
    ...
    if (editReviewId) {
      axios
        .put(`https://8080-bcdebecaeaabbdddabaaafdeafcffbbb.project.examly.io/user/editReview/${editReviewId}`, review)
        .then((response) => {
      ...
      axios
        .post('https://8080-bcdebecaeaabbdddabaaafdeafcffbbb.project.examly.io/user/addReview', review)
        .then((response) => {
  ...
  const handleDeleteReview = (id) => {
    axios
      .delete(`https://8080-bcdebecaeaabbdddabaaafdeafcffbbb.project.examly.io/reviews/deleteById/${id}`)
      .then((response) => {
