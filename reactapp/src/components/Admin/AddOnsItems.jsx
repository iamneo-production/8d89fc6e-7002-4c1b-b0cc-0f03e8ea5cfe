...
import { faIndianRupeeSign ,faPenSquare, faTrashAlt, faRupeeSign } from '@fortawesome/free-solid-svg-icons';
...
const AddOnsItems = (addOns) => {
  ...
  const deletePlan = async (addonId) => {
    const response = await axios.delete(`https://8080-bcdebecaeaabbdddabaaafdeafcffbbb.project.examly.io/admin/deleteAddon/${addonId}`);
