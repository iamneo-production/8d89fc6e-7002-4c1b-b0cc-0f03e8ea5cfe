...
const Signup = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // for user
      if (role === 'user') {
        apiURL = 'https://8080-bcdebecaeaabbdddabaaafdeafcffbbb.project.examly.io/auth/user/signup';
        ...
        apiURL = 'https://8080-bcdebecaeaabbdddabaaafdeafcffbbb.project.examly.io/admin/addUser';
        ...
        apiURL = 'https://8080-bcdebecaeaabbdddabaaafdeafcffbbb.project.examly.io/auth/admin/signup';
    ...
    <div className="signup_container">
      ...
      {requestSent ? (
        ...
        <form className="signupform" onSubmit={handleSubmit}>
          ...
          <div>
            <label htmlFor="mobileNumber" id="mobileNumber"></label>
          ...
          <button className="signup_btn" type="submit" id ="signupLink">Sign Up</button>
          <p className='log_in' id ="loginButton">Already a user? <Link to="/login">Log in</Link></p>
        </form>
        )}
      </div>
    </div>
